...
#define HD44780_SCROLL					0x1f
	#define HD44780_SCROLL_LEFT			0xfb
	#define HD44780_SCROLL_RIGHT		0xff
#define HD44780_MOVE_CURSOR				0x17
	#define HD44780_CURSOR_LEFT			0xfb
	#define HD44780_CURSOR_RIGHT		0xff
...
void LCD_ShowCustomChar(char nr);
void LCD_ShowCustomCharAt(int x,int y, char nr);
void LCD_LoadCustomCharAt(int x,int y, char nr, char *c);
void LCD_Scroll(char lr,int count);